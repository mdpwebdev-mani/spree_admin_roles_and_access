...
RSpec.describe Spree::Ability, type: :model do
  ...
  describe 'initialize' do
    ...
    it 'should receive new on Spree.user_class when there is no user passed' do
      expect(Spree.user_class).to receive(:new).and_return(user)
      Spree::Ability.new(nil)
    end

    it 'should not receive new on Spree.user_class when there is no user passed' do
